...
class TestDashboard(unittest.TestCase, BaseClass):
    ...
    def test_dashboard_totalUser(self):
        ...
        try:
            self.assertEqual(self.Dashboard.verify_total_user(), "75", msg="Verification of total user tile failed.")
    ...
    def test_dashboard_totalSales(self):
        self.LoginMethod.nativelogin(self.driver, "frugal@latido.com.np", "Test@123")
        try:
            self.assertEqual(self.Dashboard.verify_total_sales(), "75", msg="Verification of total sales tile failed.")
