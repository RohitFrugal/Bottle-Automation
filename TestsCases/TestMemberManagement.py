...
class TestMemberManagement(unittest.TestCase, BaseClass):
    ...
    def testLanding_memberManagement(self):
    ...
    @unpack
    def test_create_new_member(self, name, role, email, phone_number, address, password):
        self.LoginMethod.nativelogin("frugal@latido.com.np", "Test@123")
        try:
    ...
    @unpack
    def test_edit_member(self, name, role, email, phone_number, address, password, edit_name, edit_role, edit_phone_number):
        self.LoginMethod.nativelogin("frugal@latido.com.np", "Test@123")
        try:
    ...
    @unpack
    def test_reset_password(self, name, role, email, phone_number, address, password, reset_password):
        self.LoginMethod.nativelogin("frugal@latido.com.np", "Test@123")
        try:
    ...
    @unpack
    def test_login_newMember(self, name, role, email, phone_number, address, password):
        self.LoginMethod.nativelogin("frugal@latido.com.np", "Test@123")
        try:
