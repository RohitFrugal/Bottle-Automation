...
class TestOrder(unittest.TestCase, BaseClass):
    ...
    @unpack
    def test_01_create_order_customer(self, username, password, contactNo, gender, productname, leatherProfile,
    ...
    @unpack
    def test_02_create_new_user_order(self, username, password, contactNo, name, email, dob, address, gender, productname,
    ...
    @unpack
    def test_03_create_order_store(self, username, password, productname, leatherProfile, leatherSize, hardware, lining,
    ...
    @unpack
    def test_04_check_order_synchronization_for_Customer(self, username, password, contactNo, gender, productname, leatherProfile,
                                   leatherSize, hardware, lining, polyfill, size, armhole, height, shoulder, weight,
                                   length, arms, hips, chest, waist, sleeves, bodytype, remark, date, OTP):
        self.LoginMethod.nativelogin(username, password)
        try:
    ...
    @data(*Utils.read_xlsx("../TestData/OrderTestData/orderTestCase.xlsx", "forStore"))
    @unpack
    def test_05_check_order_synchronization_for_Store(self, username, password, productname, leatherProfile, leatherSize, hardware, lining,
                                polyfill, size, bodytype, length, chest, waist, hips, shoulder, sleeves, arms, weight, front,
                                armhole, remarks, price, discount, OTP):
        # Login with Admin
        self.LoginMethod.nativelogin(username, password)
    ...
    @unpack
    def test_06_Search_functionality(self, username, password, searchValue, productname, leatherProfile, hardware, lining, polyfill):
        # Login with Admin
        self.LoginMethod.nativelogin(username, password)
        try:
